...
- Paint: solid fill, stroke color, stroke width, line cap/join/miter/custom dash, fill/stroke alpha, CSS color functions, named colors, gradient fallback
...
- Text: basic font size, weight, italic style, font family, underline/strike decoration, anchor, first-`tspan` positioning fallback, and multi-line `tspan` extraction
