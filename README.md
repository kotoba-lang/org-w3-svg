...
- `web/app.ts` builds SVGraph, browser-local coverage diagnostics, an SVGraph presentation package projection, canonical SVG source download, DrawingML fragment XML, PresentationML slide XML, and a `.pptx` ZIP without Python or server APIs.
