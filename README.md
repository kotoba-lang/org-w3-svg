...
- DrawingML: preset geometry shapes including common polygon, arrow, and flowchart presets, custom geometry paths including line/quadratic/cubic segments, and text boxes under `p:sp`, with invalid numeric DrawingML attributes ignored where possible
